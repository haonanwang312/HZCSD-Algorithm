...
def ZO_DPDA_HICZ(delImgAT_Init_list, MGR, objfunc_list, Lap,
    ...
    for t in range(start_t, T):
        ...
        for i in range(agent_num):
            ...
            est = obj.gradient_estimation(cur + noise, MGR.parSet['mu'], MGR.parSet['q'], idx)
        ...
        for i in range(agent_num):
            e = x[i] - y[i]
            q[i] = Unbiased_l_bits_quantizer(e, l_bits)
