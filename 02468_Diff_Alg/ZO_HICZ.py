...
def main():
    ...
    delImgAT_results = zodpda.Z_O_HICZ(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-optimizer', default='ZO')
    ...
    parser.add_argument('-nStage', type=int, default=100)  #  25000
