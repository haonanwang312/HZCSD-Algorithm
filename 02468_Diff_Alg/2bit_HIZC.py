...
def main():
    ...
    delImgAT_results = twobit.two_bit_HICZ(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-optimizer', default='2-bit')
    parser.add_argument('-agent_num', type=int, default=10)
    parser.add_argument('-nFunc_per_agent', type=int, default=5)
    parser.add_argument('-batch_size', type=int, default=3)
    parser.add_argument('-l_bits', type=int, default=2)
