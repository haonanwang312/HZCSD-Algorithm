...
def Top_K_HICZ(delImgAT_Init_list, MGR, objfunc_list, Lap,
                 plot_every=1000, log_every=10, ckpt_every=200, ckpt_path=None):
    # —— Original Built-in Hyperparameters (Unchanged) ——
    alpha0, beta0, gamma0, omega0 = 0.039, 1.9, 3.0, 0.1   #0.039, 1.9, 3.0, 0.1
